...
if (!is_admin()) { redirect(BASE_URL . 'View/profile.php'); exit; }

$pageTitle  = "Admin Dashboard";
$activeDash = "dashboard";

require_once __DIR__ . '/../Model/dashboard-start-admin.php';
?>
  ...
  <div class="dash-card card">
    ...
    <div class="progress-grid">
      <div class="progress-card">
        <div class="ring" style="--p: 72"><span class="ring__value">72%</span></div>
      ...
      <div class="progress-card">
        <div class="ring" style="--p: 56"><span class="ring__value">56%</span></div>
        <div class="progress-meta">
      ...
      <div class="progress-card">
        <div class="ring" style="--p: 34"><span class="ring__value">34%</span></div>
        <div class="progress-meta">
...
<div class="dash-card card" style="margin-top:14px;">
  <div class="dash-card__head">
    ...
    <a class="btn btn-outline" href="<?= BASE_URL ?>View/subscription.php">Boost with Pro</a>
  </div>
